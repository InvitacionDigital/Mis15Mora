...
const Venis: React.FC = () => {
  return (
    <div className='w-[85%] flex flex-col justify-center items-center rounded-2xl gap-8 py-12  shadow-black mt-12 text-center text-primary'>
      <h2 className="font-normal text-7xl text-center mb-2 font-dance text-primary">¿Venís?</h2>
